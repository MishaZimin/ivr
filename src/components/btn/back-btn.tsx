    ...
    <>
      <div className={false ? "blur-[2px]" : "blur-none"}>
        <button
          ...
          onClick={handleBack}
          className={`flex flex-row min-h-[150px] relative w-[90%] mt-16 mx-auto  items-center px-4 py-4 font-bold text-black transition duration-200 transform rounded-[25px] ${state !== "sign" ? "bg-gradient-to-b from-lightred2 to-white" : "bg-white"}  hover:scale-[1.02] shadow-xl `}>
          <img
